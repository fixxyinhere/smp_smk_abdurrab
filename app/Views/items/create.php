<?php
// File: app/Views/items/create.php
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="code" name="code" value="<?= $item_code ?>" readonly>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="condition_status" name="condition_status" required>
                                    ...
                                    <option value="baik" <?= old('condition_status') == 'baik' ? 'selected' : '' ?>>Baik</option>
                                    <option value="rusak" <?= old('condition_status') == 'rusak' ? 'selected' : '' ?>>Rusak</option>
                                    <option value="hilang" <?= old('condition_status') == 'hilang' ? 'selected' : '' ?>>Hilang</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
